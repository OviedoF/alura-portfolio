  ...
  return (
    <div className="Presentation">
      <div className="Presentation__text">
        ...
        <p>
          Soy formado en Front-End, un entusiasta de la tecnología y del
          conocimiento, sobre todo en mi rama. ;)
        </p>

        <div className="Presentation__socialMedia">
          <a href="https://www.linkedin.com/in/federico-oviedo-98663221a/">
            LinkedIn
          </a>
